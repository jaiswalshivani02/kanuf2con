const data = [
  ...
  function removeAdmin() {
    ...
    //data = removedAdmins;
    console.log("After removed all admins:", removedAdmins);
  }
  
  // 4. Concatenate Array
  function concatenateArray() {
    const dummyArray = [
      { id: 4, name: "Shivani", age: 22, profession: "developer", salary: 1200 },
      { id: 5, name: "Snehal", age: 21, profession: "admin", salary: 950 },
    ];
